...
* **🔁 Reproducibility:** What it means, how it differs from replicability and reusability, and why it matters.
* **⚙️ Reproducible analytical pipelines (RAP):** What RAPs are and why they matter.
* **🧐 Reproducible work v.s. RAPs:** Key distinctions.
* **📖 Focus of this book:** Supporting both reproducibility and full RAPs.

At the end, you will find 🧪 test yourself and 💬 comments sections. 
...
## ⚙️ Reproducible analytical pipelines (RAP)
...
cat(longmcq(c(
  "Independent rebuild of the model without code.",
...
cat(longmcq(c(
   ...
   answer = "It makes code easier to revisit and reuse, improves quality, saves time, and builds trust."
)))
```
