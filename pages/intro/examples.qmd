...
The original study implemented the model using SIMUL8 software.

In a subsequent study, we attempted to replicate the model in Python through iterative prompting of a large language model:
...
>
> * [Main repository](https://github.com/pythonhealthdatascience/llm_simpy)
> * [Deployed apps](https://github.com/pythonhealthdatascience/llm_simpy_models).

In this book, based on the published description of the model's logic and parameters, we have recreated it in both Python and R. (Note: this did not use code from the previous LLM-based reconstruction).

#### Code repositories

* [Python version](https://github.com/pythonhealthdatascience/pydesrap_stroke)
* [R version](https://github.com/pythonhealthdatascience/rdesrap_stroke)
