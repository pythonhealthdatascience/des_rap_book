...
**2. Provide citation details directly**. Example for DES RAP Book (as of 5th January 2026):
...
Heather, A., Monks, T., Mustafee, N., Harper, A., & Alidoost, F. (2025). DES RAP Book: Reproducible Discrete-Event Simulation in Python and R (Version 0.3.0) [Computer software]. https://github.com/pythonhealthdatascience/des_rap_book
```
:::
