...
## What is the main purpose of a changelog in a simulation project?

```{r}
#| output: asis
#| echo: false
cat(longmcq(c(
  "To keep a copy of all GitHub commits.",
  "To store all the results from the simulation and any changes.",
  answer = paste0(
    "To provide a human-readable record of what changed between version of ",
    "code."
  )
)))
```
...
## From a reproducibility and open‑science perspective, why is linking a publication to a specific tagged release important?
...
cat(longmcq(c(
  answer = paste0(
    "It ensures that readers, reviewers, and future users can find and run ",
    "the exact code version underlying the published results, even as the ",
    "project evolves."
  ),
  "It prevents you from updating the repository in the future."
)))
```
