...
* **Why do QA?** It helps build trust in the work by ensuring the right processes are followed, and that analysis and results are checked.
    ...
    * [Harper et al. (2021)](https://doi.org/10.1016/j.ejor.2020.06.043) show that trust in a simulation does not come from a single thing, but from many elements working together. These include (among other things): the credibility of the modellers, transparency of assumptions, suitability of methods, and how well the model answers the decision question. The QA activities on this page provide a structured way to address those facets systematically (for example through clear roles, documentation, and independent assurance).
...
![](quality_assurance_resources/qa.png){fig-alt="Illustration representing quality assurance."}
...
In summary, the commissioner and approver mainly shape institutional and decision‑level trust (is this suitable to base decisions on?), while the analyst and assurer focus on technical and process trust (is the model well‑built, transparent, and appropriately checked?). Making these roles explicit helps you design QA that supports trust in the model and its results across different stakeholders.
...
**Assurance of code and workflows**. Make sure you code and workflow follow good practice for quality and reproducibility (for example, version control, testing, code review). For example, you achieve this by meeting recommendations from the [STARS Reproducibility Recommendations](/pages/frameworks/stars_reproducibility.qmd) and [NHS Levels of RAP](/pages/frameworks/levels_of_rap.qmd).
...
* **Maintaining an ongoing record** of data sources, assumptions, inputs, and decisions  - including any changes to the analytical plan or decisions made during analysis.
...
The example models for this book include a retrospective QA summary in the `docs/quality_assurance.md` file. This describes how QA not formally planned or documented during the project, but has been retrospectively summarised to reflect on what was done incidentally and what would be done differently in future projects.

## Resources

Key resources to check out when planning your quality assurance:

* The [AQuA Book](https://www.gov.uk/guidance/the-aqua-book) from the Government Analysis Function.

* The [Framework to review models](https://www.nao.org.uk/wp-content/uploads/2016/03/11018-002-Framework-to-review-models_External_4DP.pdf) from the National Audit Office.

* The [Quality Assurance Maturity Model](https://www.gov.uk/government/publications/analytical-quality-assurance-at-the-department-for-education) from the Department for Education.

* The [Quality Assurance (QA) tools and guidance](https://www.gov.uk/government/publications/energy-security-and-net-zero-modelling-quality-assurance-qa-tools-and-guidance) from the Department for Energy Security and Net Zero modelling.
