...
```{python}
#| echo: false
{{< include /pages/guide/output_analysis/parallel_resources/parameters.py >}}
{{< include /pages/guide/output_analysis/replications_resources/patient.py >}}
{{< include /pages/guide/output_analysis/replications_resources/monitored_resource.py >}}
{{< include /pages/guide/output_analysis/replications_resources/model.py >}}
{{< include /pages/guide/output_analysis/replications_resources/summary_stats.py >}}
{{< include /pages/guide/output_analysis/parallel_resources/runner.py >}}
```
