...
![Example 1: M/M/s model](/pages/example_models/examples_resources/nurse_des.drawio.png)

:::

::: {.column width=70%}

![Example 2: Stroke model](/pages/example_models/examples_resources/stroke_rehab_design.png)
