...
The nurse visit model doesn't import them from a file. It instead stores them within a script, as covered on the [parameters from script](parameters_script.qmd) page.
