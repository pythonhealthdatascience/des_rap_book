...
Creating a GitHub action to run your model tests is really helpful, as it helps ensure you are running you tests regularly (e.g., everytime you merge into main). This is important for [regression testing](../verification_validation/verification_validation.qmd#regression-testing), a form of model verification which involves re-running your tests everytime you make changes to ensure those changes haven't introduced new errors.
