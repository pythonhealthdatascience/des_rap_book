...
![](patients_resources/book_des.drawio.png)
...
The best approach is to building your model is to go carefully **step by step**, testing and understanding each component before adding more complexity. Typically, the first step is to write code that **generates arrivals into the system**.
...
When you hover over the code below, any changes will be highlighted in **bold**.
