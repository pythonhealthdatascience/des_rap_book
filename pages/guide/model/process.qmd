...
![](process_resources/book_des_consult.drawio.png)

You can hover over the code to see the changes highlighted in **bold**. Follow along and modify your code as indicated to add the consultation step to your model.
