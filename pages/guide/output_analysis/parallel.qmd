...
On this page, we are making changes to the simulation code from the [Replications](replications.qmd) page - but the `Parameters` class has been updated based on the determined [length of warm-up](length_warmup.qmd), a data collection period of 2 weeks (20,160 minutes), and the determined [number of replications](n_reps.qmd).
