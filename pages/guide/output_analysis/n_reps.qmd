...
As an alternative to manually determining the number of runs required, we can use a more automated method. In this automated method, an algorithm will tell us the number of runs needed. We will use the `ReplicationsAlgorithm` class from [sim-tools](https://github.com/TomMonks/sim-tools).
