...
class MonitoredResource(simpy.Resource):
    ...
    def update_time_weighted_stats(self):
        ...
        At each resource request or release, adds time resources were busy
        (number of resources in use x duration).
...
class Model:
    ...
    def run(self):
        ...
        # resources in use or requests in queue by accounting for the time#<<
        # from the last event up to the simulation finish.#<<
