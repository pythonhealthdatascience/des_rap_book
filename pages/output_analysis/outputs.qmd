...
* `time_last_n_in_system` - a list recording the last time the number-in-system statistic was updated
...
class Model:
    ...
    area_n_in_system : list of float#<<
        List containing incremental area contributions used for time-weighted
        statistics of the number of patients in the system.
