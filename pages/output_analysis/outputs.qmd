...
| Performance measure | Time-weighted? | Includes warm-up patients still there during in data collection period? |
| - | - | - |
| Total arrivals | No | No |
| Mean wait time | No | No |
| Mean time in consultation | No | No |
| Mean doctor utilisation | Both | Yes |
| Mean queue length | Yes | Yes |
| Mean time in system | No | No |
| Mean number of patients in the system | Yes | Yes |
| Backlogged patient count | No | Yes |
| Backlogged patient mean wait time | No | Yes |
