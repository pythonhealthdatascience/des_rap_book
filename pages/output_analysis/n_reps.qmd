...
The simulation being used is that from the [Length of warm-up](replications.qmd) page - but the `Parameters` class has been updated based on the determined length of warm-up on the previous page, and a data collection period of 2 weeks (20,160 minutes). <!--TODO: check length of warm-up here in python v.s. R v.s. result from warm-up page-->
