...
* **Reading the code** - look through the code line-by-line to see if it makes sense and spot any possible issues.
    * A issue that can sometimes crop up is **time units** - make sure consistent time units are used throughout (e.g., minutes v.s. hours v.s. days) (@Rosser2025).
    * Another is reproducibility - make sure that you are **able to reproduce results** (@Rosser2025).
...
✔️ Conduct warm-up analysis to determine appropriate initialisation period - see [initialisation bias](../output_analysis/warmup.qmd) page.

✔️ Use statistical methods to determine sufficient run length and number of replications - see [number of replications](../output_analysis/n_reps.qmd) page.
