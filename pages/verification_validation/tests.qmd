...
```{r}
#| echo: false
testthat::test_file("tests_resources/test_example_param.R")
```
...
cases(
  list(param_name = "interarrival_time", init_value = 2, adj_value = 15),
  list(param_name = "data_collection_period", init_value = 2000, adj_value = 500)
))
```
...
```{r}
#| echo: false
testthat::test_file("tests_resources/test_unit.R")
```
...
```{r}
testthat::test_file("tests_resources/test_back.R")
```
