...
## ↗️ Sharing your simulation model
...
| - | - | - |
| Strengthening the reporting of empirical simulation studies-DES (STRESS-DES) | [Monks et al. (2019)](https://doi.org/10.1080/17477778.2018.1442155) | Reporting all necessary information for replication of simulations |
| Generic reporting checklist | [Zhang et al. (2020)](https://doi.org/10.1016/j.jval.2020.01.005) | Model quality |
...
| TRAnsparent and Comprehensive model Evaluation (TRACE) | [Grimm et al. (2014)](https://doi.org/10.1016/j.ecolmodel.2014.01.018) | Transparent documentation and evaluation |
...
| - | - | - |
| STARS framework | [Monks et al. (2024)](https://doi.org/10.1080/17477778.2024.2347882) | Model sharing and reuse |
| STARS reproducibility recommendations | [Heather et al. (2025)](https://doi.org/10.1080/17477778.2025.2552177) | Reproducibility |
| NHS "Levels of RAP" Maturity Framework | [NHS RAP Community of Practice](https://nhsdigital.github.io/rap-community-of-practice/introduction_to_RAP/levels_of_RAP/) | Developing reproducible analytical pipelines |
...
## 🗄️ How to archive your repository on Zenodo
...
#| echo: false
cat(longmcq(c(
  "This will not meet the requirements of all journals - they all require direct code sharing now.",
  answer = "Code is often lost or unavailable, and most requests are not fulfilled.",
  "Code doesn't need to be shared if the results are clearly described in the publication."
)))
```
