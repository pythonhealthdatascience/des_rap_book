...
cat(longmcq(c(
  ...
  answer = "They may only use the repository owner’s username or incomplete information."
)))
```
...
#| echo: false
cat(longmcq(c(
  answer = "It facilitates direct import to reference managers and supports BibTeX conversion.",
