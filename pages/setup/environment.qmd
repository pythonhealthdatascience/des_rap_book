...
In the project root, we create a file called `environment.yaml`. Within this file, we add three sections:
...
With the environment active, you can then run the following command to update it:
