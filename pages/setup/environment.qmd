...
<!--TODO: This could be a nice place to add illustrations for each of these benefits-->
...
**2. Build and activate the environment**. In the command line, run the following to create and activate the environment:
...
Then update your active environment (after running `conda activate hospital-des`) with:
