...
::: {.callout-note collapse="true"}
## Manual installation and switching with update-alternatives
...
Follow [installation instructions](https://github.com/r-lib/rig) for your operating system. For example, on Linux Ubuntu:
...
See the [rig GitHub repository](https://github.com/r-lib/rig) for further information on using it.
