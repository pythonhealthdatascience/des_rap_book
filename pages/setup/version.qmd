# Version control and Git {#sec-version}
...
* **README:** Select "Add a README file", which will create a blank README we can populate later (see @sec-documentation).
