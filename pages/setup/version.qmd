...
![](version_resources/github_3.png)
...
On the main page of you repository, click the green "<> Code" button, then copy the HTTPS url.

![](version_resources/github_4.png)

### 2. Clone the repository

Depending on your operating system, open either the terminal (Linux or Mac) or Git Bash (windows). Navigate to the location where you would like to create the folder containing your repository. Then enter `git clone` and the pasted URL - for example:
...
One of the easiest ways to merge changes into main is using the GitHub website. Open your repository. You should see that you now have "2 Branches". Navigate to your new branch...
