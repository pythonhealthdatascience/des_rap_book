...
![](rap_resources/reproduce.png){fig-alt="Illustration showing that reproducibility involves code and data being used to produce the expected tables and charts."}
...
![](rap_resources/rap.png){fig-alt="Illustration showing that RAP is an end-to-end process, from data to code to outputs."}
...
* It also guides you through building a full **RAP**, following the [NHS "Levels of RAP" maturity framework](/pages/frameworks/levels_of_rap.qmd) as a concrete example, chosen because it was developed specifically for the NHS healthcare context. Although NHS-focused, the underlying RAP principles and levels of maturity are broadly relevant to analytical work in other settings as well.
