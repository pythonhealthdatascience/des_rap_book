...
![](/pages/guide/inputs/input_data_resources/samples.png){fig-alt="Illustration showing multiple samples being taken from one distribution."}
...
![Activity-based approach](des_resources/activity_based.drawio.png){fig-alt="Illustration of activity-based approach"}
...
![Event-based approach](des_resources/event_based.drawio.png){fig-alt="Illustration of event-based approach"}
...
![Process-based approach](des_resources/process_based.drawio.png){fig-alt="Illustration of process-based approach"}
...
![Three-phase approach](des_resources/three_phase.drawio.png){fig-alt="Illustration of three-phase approach"}
