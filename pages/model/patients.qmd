...
<!--TODO: switch from bibliography to manual references, as it doesn't allow conditional python/r content references -->

:::: {.pale-blue}

🎯 **Objectives**

This page creates a simple model that samples arrivals, with inspiration from @hsma_des_book for the Python version.
...
<!--TODO: add note: results can differ... its about order that dists are set up... using new seeds... if switch to use registry, are they set up in same order? alphabetical?-->
...
<!--TODO:this feels wrong with code... you are hard coding exponential... but if you make it input, that doesn't fit, as the params you provide are hard coded anyway! should i say this would more typically be a file?-->
