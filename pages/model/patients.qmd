...
For now, this will just have one attribute: `patient_id`. However, when we start tracking [Performance measures](../output_analysis/outputs.qmd), this class will be modified to store other attributes useful for output analysis.
