# Parameters from script {#sec-param_script}
...
Your choice may be further informed by options for parameter validation, where classes can be superior as you can incorporate validation within the class, as discussed on the page "@sec-param_validation".
