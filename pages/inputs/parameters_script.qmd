...
* **✅ Recommendation for managing parameters in DES:** grouping parameters into a dedicated object and passing that object explicitly to your model.
* **🧮 Handling a large number of parameters**.
* **🧾 Examples:** Full code examples from our example simulation models.

If you want to see how to store parameters in a separate file, see the [parameters from file](parameters_file.qmd) page.
...
This example is from `R/parameters.R` in [rdesrap_stroke](https://github.com/pythonhealthdatascience/rdesrap_stroke).

```{.python}
{{< include ../../examples/rdesrap_stroke/R/parameters.R >}}
```
