...
🩺 We didn't create a similar file-based example for the nurse M/M/s model due to its simplicity with only a few parameters.
...
#'
#' @return A named list containing all simulation parameters organized by 
...
:::{.python-content}
This example is from `notebooks/parameters_csv.ipynb` in [stroke_rap_python](https://github.com/pythonhealthdatascience/stroke_rap_python).
:::
:::{.r-content}
