...
* ☑️ In documentation (e.g. `README.md`), **describe** the dataset (e.g. "*Patient records from XYZ database, covering 2012–2017, with fields for arrival, service, and departure times.*").

* ☑️ If possible, share the **data dictionary** to demonstrate the structure and content of the dataset.
